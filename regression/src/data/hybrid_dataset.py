...
class VGDDataset(Dataset):
    def __init__(self, split, metadata_file, config_path, data_dir, seq_len, time_split=False):
        ...
        #     self.metadata_file = "../emilia_aoi/train_metadata.csv"
        # elif self.split == 'validation':
        #     self.metadata_file = "../emilia_aoi/val_metadata.csv"
        # elif self.split == 'test':
        #     self.metadata_file = "../emilia_aoi/test_metadata.csv"
        ...
        # except:
        #     self.mask = self.mask.chunk(chunks='auto')
        ...
        for var_name in sorted(self.stats['mean']['dynamic'].keys()):
            self.dynamic_data[var_name] = None

        for var_name in sorted(self.stats['mean']['static'].keys()):
            self.static_data[var_name] = None
